...
export default function SingleProductThumbnails({
  ...
  return (
    <div className="flex flex-col gap-4">
      <h5 className="font-black tracking-[0.4em] uppercase text-black-03">
        Gallery Selection_
      </h5>
        ...
        {thumbnails.map((thumbnail, index) => {
          ...
          return (
            <div
              ...
              className={cn(
                "relative w-20 h-20 md:w-40 md:h-auto cursor-pointer overflow-hidden transition-all duration-500",
                isActive
